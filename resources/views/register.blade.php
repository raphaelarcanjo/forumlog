...
@section('content')
    ...
    <form action="{{url('user/register')}}" method="post">
        ...
        <div class="row">
            <div class="input-field col s12 m4">
                <input value="{{ old('phones')[0] ?? '' }}" type="text" class="phone" minlength="14" maxlength="15" id="phone1" name="phones[]" />
                <label for="phone1">Telefone 1</label>
            </div>
            <div class="input-field col s12 m4">
                <input value="{{ old('phones')[1] ?? '' }}" type="text" class="phone" minlength="14" maxlength="15" id="phone2" name="phones[]" />
                <label for="phone2">Telefone 2</label>
            </div>
            <div class="input-field col s12 m4">
                <input value="{{ old('phones')[2] ?? '' }}" type="text" class="phone" minlength="14" maxlength="15" id="phone3" name="phones[]" />
