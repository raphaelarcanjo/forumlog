...
CREATE TABLE `addresses` (
  ...
  `suburb` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `forums` (
  ...
  CONSTRAINT `forums_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no-image.jpg',
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2020_04_20_155426_create_forums_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2020_04_20_155442_create_blogs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2020_06_25_125704_create_blog_comments',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2021_11_22_111856_create_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2021_11_22_113032_create_phones_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2023_12_05_233232_add_username',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2023_12_05_234049_create_birth',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2023_12_05_234050_create_active',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2023_12_05_234052_create_photo',5);
